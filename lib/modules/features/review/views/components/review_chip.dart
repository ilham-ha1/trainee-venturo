          ...
          return Obx( () =>
            Material(
              ...
              child: Padding(
                ...
                child: InkWell(
                  onTap: () {
                    final ReviewController reviewController = ReviewController.to;
                  ...
                  child: Ink(
                    ...
                    decoration: BoxDecoration(
                      ...
                      color: chip == ReviewController.to.selectedChip?.value
                          ? MainColor.primary
                          : MainColor.white,
                    ),
                    child: Padding(
                          ...
                          children: [
                            Text(
                              ...
                              style: GoogleFonts.montserrat(
                                color: chip ==
                                        ReviewController.to.selectedChip?.value
                                    ? MainColor.white
                                    : MainColor.black,
                                fontSize: 12.sp,
                              ),
                            ),
                            chip == ReviewController.to.selectedChip?.value
                                ? const Padding(
