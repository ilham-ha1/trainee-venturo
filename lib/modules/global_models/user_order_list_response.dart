...
UserOrderListResponse userOrderListResponseFromJson(String str) =>
    UserOrderListResponse.fromJson(json.decode(str));

String userOrderListResponseToJson(UserOrderListResponse data) =>
...
class UserOrderListResponse {
  ...
  factory UserOrderListResponse.fromJson(Map<String, dynamic> json) =>
      UserOrderListResponse(
        ...
        data: json["data"] == null
            ? []
            : List<UserOrderListData>.from(
                json["data"]!.map((x) => UserOrderListData.fromJson(x))),
      );
...
class UserOrderListData {
  ...
  factory UserOrderListData.fromJson(Map<String, dynamic> json) =>
      UserOrderListData(
        ...
        menu: json["menu"] == null
            ? []
            : List<OrderListMenu>.from(
                json["menu"]!.map((x) => OrderListMenu.fromJson(x))),
      );
